namespace Binary
{
	partial class IntroUI
	{
		...
		private void InitializeComponent()
		{
			...
			this.PictureBoxUpdates.Click += new System.EventHandler(this.PictureBoxUpdates_Click);
			// 
			// PictureBoxMaximized
			// 
			...
			this.PictureBoxAutoBackups.Click += new System.EventHandler(this.PictureBoxAutoBackups_Click);
			// 
			// PictureBoxSoon
			// 
			...
			this.PictureBoxSoon.Click += new System.EventHandler(this.PictureBoxSoon_Click);
			// 
			// PictureBoxTheme
			// 
